...
def scraping_zip    (job = None, city = None, state = None):
    ...
    data = pd.DataFrame({'job_title' : final_titles, 'job_description' : final_descriptions, 'company' : final_companies, 'state' : final_states, 'city' : final_cities })

    return data

if __name__ == '__main__':
    data = scraping_zip('data scientist', 'San Francisco', 'CA')
    data.to_csv('data/zip_data')
